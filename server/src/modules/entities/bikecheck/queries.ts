  ...
  params: [
    {
      ...
      codeRefs: { used: [{ a: 138, b: 143, line: 3, col: 9 }] },
    },
    {
      name: 'telegramImageId',
      required: false,
      transform: { type: 'scalar' },
      codeRefs: { used: [{ a: 147, b: 161, line: 3, col: 18 }] },
    },
  ],
  ...
  params: [
    {
      ...
      required: false,
      transform: { type: 'scalar' },
      codeRefs: { used: [{ a: 272, b: 273, line: 9, col: 14 }] },
    },
  ],
  usedParamSet: { id: true },
  statement: {
    body: 'SELECT *\r\nFROM "Bikecheck"\r\nWHERE "id" = :id',
    loc: { a: 230, b: 273, line: 7, col: 0 },
  },
};
  ...
  params: [
    {
      ...
      required: false,
      transform: { type: 'scalar' },
      codeRefs: { used: [{ a: 349, b: 354, line: 14, col: 18 }] },
    },
  ],
  usedParamSet: { userId: true },
  statement: {
    body: 'SELECT *\r\nFROM "Bikecheck"\r\nWHERE "userId" = :userId AND "isActive" = TRUE\r\nORDER BY "createdAt" DESC',
    loc: { a: 303, b: 403, line: 12, col: 0 },
  },
};
  ...
  params: [
    {
      ...
      required: false,
      transform: { type: 'scalar' },
      codeRefs: { used: [{ a: 481, b: 486, line: 20, col: 18 }] },
    },
  ],
  usedParamSet: { userId: true },
  statement: {
    body: 'SELECT *\r\nFROM "Bikecheck"\r\nWHERE "userId" = :userId AND "isActive" = FALSE\r\nORDER BY "createdAt" DESC',
    loc: { a: 435, b: 536, line: 18, col: 0 },
  },
};
  ...
  params: [
    {
      ...
      required: false,
      transform: { type: 'scalar' },
      codeRefs: { used: [{ a: 601, b: 606, line: 26, col: 14 }] },
    },
    {
      name: 'telegramImageId',
      required: false,
      transform: { type: 'scalar' },
      codeRefs: { used: [{ a: 633, b: 647, line: 27, col: 23 }] },
    },
    {
      name: 'isActive',
      required: false,
      transform: { type: 'scalar' },
      codeRefs: { used: [{ a: 667, b: 674, line: 28, col: 16 }] },
    },
    {
      name: 'onSale',
      required: false,
      transform: { type: 'scalar' },
      codeRefs: { used: [{ a: 716, b: 721, line: 30, col: 14 }] },
    },
    {
      name: 'saleRank',
      required: false,
      transform: { type: 'scalar' },
      codeRefs: { used: [{ a: 741, b: 748, line: 31, col: 16 }] },
    },
    {
      name: 'id',
      required: false,
      transform: { type: 'scalar' },
      codeRefs: { used: [{ a: 765, b: 766, line: 32, col: 14 }] },
    },
  ],
  usedParamSet: {
    userId: true,
  ...
  params: [
    {
      ...
      required: false,
      transform: { type: 'scalar' },
      codeRefs: { used: [{ a: 879, b: 884, line: 38, col: 18 }] },
    },
  ],
  usedParamSet: { userId: true },
  statement: {
    body: 'SELECT COUNT("id")\r\nFROM "Bikecheck"\r\nWHERE "userId" = :userId AND "isActive" = TRUE',
    loc: { a: 823, b: 906, line: 36, col: 0 },
  },
};
...
const findOnSaleIR: any = {
  ...
  statement: {
    ...
    loc: { a: 936, b: 1032, line: 41, col: 0 },
  },
};
  ...
  params: [
    {
      ...
      required: false,
      transform: { type: 'scalar' },
      codeRefs: { used: [{ a: 1296, b: 1301, line: 58, col: 20 }] },
    },
  ],
  usedParamSet: { userId: true },
  statement: {
    ...
    loc: { a: 1061, b: 1398, line: 47, col: 0 },
  },
};
